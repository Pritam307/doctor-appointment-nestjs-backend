...
export class AppointmentController {
  ...
  @ApiOperation({
    ...
    description:
      'Book a new appointment with a doctor. Requires authentication. The system will check for overlapping appointments and prevent double-booking.',
  })
  @ApiBody({
      ...
      properties: {
        ...
        message: {
          oneOf: [
            ...
            {
              type: 'string',
              example: 'Doctor is already booked at this time',
            },
            {
              type: 'array',
              items: { type: 'string' },
              example: ['patientName should not be empty'],
            },
          ],
        },
